...
internal sealed class DownloadMediaImageCommandHandler : IRequestHandler<DownloadMediaImageCommand, Stream>
{
    ...
    public async Task<Stream> Handle(DownloadMediaImageCommand request, CancellationToken cancellationToken)
    {
